      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {vendors.map((v) => (
            <div
              key={v.id}
              className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex justify-between items-start"
            >
          ...
          {vendors.length === 0 && (
            <div className="text-slate-400 col-span-2 text-center py-8">
